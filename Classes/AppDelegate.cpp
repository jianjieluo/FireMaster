...
void AppDelegate::loadGameResource() {
  ...
  SpriteFrameCache::getInstance()->addSpriteFramesWithFile(
      "imges/FireMaster.plist", "imges/FireMaster.png");
  char frameName[30];
  ...
  AnimationCache::getInstance()->addAnimation(yellowTankAttackAnimation,
                                              "yellowTankAttackAnimation");
  AnimationCache::getInstance()->addAnimation(blueTankAttackAnimation,
                                              "blueTankAttackAnimation");
  AnimationCache::getInstance()->addAnimation(yellowTankAfterAttackAnimation,
                                              "yellowTankAfterAttackAnimation");
  AnimationCache::getInstance()->addAnimation(blueTankAfterAttackAnimation,
